    ...
    <div style=" border :1px solid  ; border-color:black ; width: 600px; height: 460px">
      <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
         <h2> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <u>Voulez vous modifier cet item ? </u></h2>
          ...
          <center>
           <input  id ="ModifIm1" name="ModifIm1" placeholder="Prix" type="number" >
          &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
           <input  id ="ModifEn1" name="ModifEn1" placeholder="Prix min" type="number"  >
          &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
          <input id ="ModifMe1" name="ModifMe1" placeholder="Prix min" type="number" > </center><br>
