  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="Connexion.html" style="color:#ecf0f1"><span class="glyphicon glyphicon-user"></span><b><font size = "+1"> Compte </font></b></a></li>
...
<div class="container-fluid text-center">
    <div>
      <img src="logo5.png" width="250" height="60">
  ...
  <div class="form" style=" padding-left: 100px; padding-right: 100px;padding-top: 10px">
    <div style="background-color: #ffffff; border: 5px solid; border-color: #22a6b3">
       ...
       <h2 style="color:#22a6b3"><b> <?php echo "Votre article :<center> ".$_SESSION['NomArticle'].'  <br/> Description :'.$_SESSION['Description'] .'<br/> Mode de vente : '.$_SESSION['Enchere'].'</center>'; ?></b></h2>
       <br><br><br> 
