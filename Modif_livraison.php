      ...
      ?>
             ...
             <div class='form-row'>
              ...
              <div class='col-xs-12'>
                ...
                <input class='form-control' name="Adresse1" size='4' type='text' placeholder='Ligne 1' value=" <?php echo $Donnee['Adresse1'] ?>">
              ...
              <div class='col-xs-4'>
                ...
                <input  class='form-control' name='Ville' placeholder=' size='4' type='text' value=" <?php echo $Donnee['Ville'] ?>">
              </div>

              <div class='col-xs-4'>
                <label class='control-label'>Code Postal</label>
                <input  class='form-control' name='CodeP' placeholder='' size='4' type='text' value=" <?php echo $Donnee['CodeP'] ?>">
              </div>

              <div class='col-xs-4'>
                <label class='control-label'>Pays</label>
                <input class='form-control' name='Pays' placeholder='' size='2' type='text' value=" <?php echo $Donnee['Pays'] ?>">
              </div>
              <br><br><br><br><br>
            </div>
              ...
              <div class='col-xs-12'>
                ...
                <input class='form-control' name='CarteNom' size='4' type='text' value=" <?php echo $Donnee['CarteNom'] ?>">
              </div><br><br><br>
            </div>
            <div class='form-row'>
              <div class='col-xs-12 '>
                <label class='control-label'>Numéro de carte</label>
                <input class='form-control' name='CarteNum' size='20' type='text' value=" <?php echo $Donnee['CarteNum'] ?>"> 
              </div><br><br><br>
            </div>
            <div class='form-row'>
              <div class='col-xs-4'>
                <label class='control-label'>CVC</label>
                <input  class='form-control' name='CVC' placeholder='ex. 311' size='4' type='text' value=" <?php echo $Donnee['CVC'] ?>">
              </div>
              <div class='col-xs-8'>
                <label class='control-label'>Expiration</label>
                <input class='form-control' name='Expiration' placeholder='JJ-MM-AAAA' size='2' type='text' value=" <?php echo $Donnee['Expiration'] ?>">
              </div>
              <br><br><br><br><br>
            </div>
